(function(){
    ...
    function estimate(body){
        const unicode=[...body].some(ch=>{const c=ch.codePointAt(0);return c<0x20||c>0x7e});
        const n=[...body].length;
        const single=unicode?70:160, multi=unicode?67:153;
        return {encoding:unicode?'UCS2':'GSM-7',segments:n<=single?1:Math.ceil(n/multi),chars:n};
    }
